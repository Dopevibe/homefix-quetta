...
<div class="flex-1 flex flex-col min-w-0 overflow-hidden bg-slate-900">
    ...
    <header class="min-h-[4rem] h-auto sm:h-16 py-2.5 sm:py-0 bg-slate-950 border-b border-slate-800 flex items-center justify-between px-4 sm:px-6 shrink-0 z-20 gap-3">
        <div class="flex items-center gap-3 min-w-0">
            ...
            <h2 class="text-base sm:text-lg font-extrabold font-heading text-white tracking-tight truncate">Service Categories</h2>
        </div>
        <button type="button" id="openAddCategoryModal" class="btn-primary px-3 sm:px-4 py-2 rounded-xl text-xs font-bold flex items-center gap-1.5 shadow-md shrink-0 whitespace-nowrap">
