    ...
    <header class="min-h-[4rem] h-auto sm:h-16 py-2.5 sm:py-0 bg-slate-950 border-b border-slate-800 flex items-center justify-between px-4 sm:px-6 shrink-0 z-20 gap-3">
        <div class="flex items-center gap-3 min-w-0">
            ...
            <div class="min-w-0">
                ...
                <h1 class="text-base sm:text-lg font-extrabold font-heading text-white tracking-tight truncate">Support Inquiries</h1>
            </div>
        </div>

        <div class="flex items-center gap-2 shrink-0">
            <span class="text-xs font-mono font-bold text-teal-400 bg-slate-900 px-3 py-1.5 rounded-xl border border-slate-800 whitespace-nowrap">
