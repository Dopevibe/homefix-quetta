...
<div class="flex-1 flex flex-col min-w-0 overflow-hidden bg-slate-900">
    ...
    <header class="min-h-[4rem] h-auto sm:h-16 py-2.5 sm:py-0 bg-slate-950 border-b border-slate-800 flex items-center justify-between px-4 sm:px-6 shrink-0 z-20 gap-3">
        <div class="flex items-center gap-3 min-w-0">
            <button id="adminSidebarToggle" class="lg:hidden p-2 rounded-xl text-slate-400 hover:text-white hover:bg-slate-800 shrink-0 transition" aria-label="Toggle sidebar">
                <i data-lucide="menu" class="w-5 h-5"></i>
            </button>
            <div class="min-w-0">
                <!-- Subtle Breadcrumb -->
                <div class="hidden sm:flex items-center gap-1.5 text-xs text-slate-500 mb-0.5">
                    <span>Admin</span>
                    <i data-lucide="chevron-right" class="w-3 h-3 text-slate-600"></i>
                    <span class="text-teal-400 font-medium">Settings</span>
                </div>
                <h1 class="text-base sm:text-lg font-extrabold font-heading text-white tracking-tight truncate">Account Settings</h1>
            </div>
        </div>
